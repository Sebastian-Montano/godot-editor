...
/** @type {string} */
const CACHE_VERSION = '4.5.2.stable.official';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["index.html", "offline.html", "godot.editor.js", "godot.editor.audio.worklet.js", "godot.editor.audio.position.worklet.js", "logo.svg", "favicon.png"];
